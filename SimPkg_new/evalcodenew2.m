...
steer_input = 0.5*[-0.001*ones(250,1);0*ones(50,1);0*ones(50,1);-1*ones(50,1);-0.98*ones(50,1);-0.99*ones(50,1);-0.97*ones(50,1);-0.96*ones(50,1);-0.95*ones(50,1);-0.94*ones(50,1);...
    -0.99*ones(50,1);-0.98*ones(50,1);-0.95*ones(50,1);-0.99*ones(50,1);-0.9*ones(50,1);-0.8*ones(50,1);-0.85*ones(50,1);-0.9*ones(50,1);-0.95*ones(50,1);-0.92*ones(50,1);...
    -1*ones(50,1);-0.7*ones(50,1);-0.01*ones(50,1);0.02*ones(50,1);0.01*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);...%%danger
    0*ones(50,1);0.4*ones(50,1);0.5*ones(50,1);0.6*ones(50,1);0.5*ones(50,1);0.6*ones(50,1);0.5*ones(50,1);0.4*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);...
    -0.1*ones(50,1);-0.1*ones(50,1);-0.5*ones(50,1);-0.5*ones(50,1);-0.5*ones(50,1);-0.5*ones(50,1);-0.5*ones(50,1);-0.5*ones(50,1);-0*ones(50,1);...
    0.1*ones(50,1);0.1*ones(50,1);0.1*ones(50,1);0.1*ones(50,1);0.1*ones(50,1);0.1*ones(50,1);0.2*ones(50,1);0.2*ones(50,1);0.2*ones(50,1);...
    0*ones(50,1);-0.1*ones(50,1);-0.2*ones(50,1);-0.2*ones(50,1);-0.2*ones(50,1);-0.25*ones(50,1);-0.2*ones(50,1);-0.2*ones(50,1);...
    -0.4*ones(50,1);-0.4*ones(50,1);-0.4*ones(50,1);-0.4*ones(50,1);-0.2*ones(50,1);-0.2*ones(50,1);-0.2*ones(50,1);-0.3*ones(50,1);-0.3*ones(50,1);-0.4*ones(50,1);...
   -0.4*ones(50,1);-0.4*ones(50,1);-0.4*ones(50,1);-0.4*ones(50,1);-0.4*ones(50,1);0.2*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0.4*ones(50,1);...
   0.4*ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);...
   -ones(50,1);0*ones(50,1);0*ones(50,1);-ones(50,1);-1*ones(50,1);-ones(50,1);-ones(50,1);-ones(50,1);-ones(50,1);-ones(50,1);-ones(50,1);-ones(50,1);...
   -ones(50,1);-ones(50,1);-ones(50,1);0*ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);...
   ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);0*ones(50,1);...
   0*ones(50,1);0*ones(700,1)
   ];
% steer_input = [-0.000*ones(300,1);-0.2*ones(300,1);-0.5*ones(150,1)];
force_input = 5000*[ones(250,1);0.99*ones(50,1);0.98*ones(50,1);0.94*ones(50,1);0.99*ones(50,1);0.98*ones(50,1);0.97*ones(50,1);-1.98*ones(50,1);-1.99*ones(50,1);-1.98*ones(50,1);-1*ones(50,1);...
    0.98*ones(50,1);0.97*ones(50,1);0.99*ones(50,1);0.98*ones(50,1);0.99*ones(50,1);-0.98*ones(50,1);-0.99*ones(50,1);-0.2*ones(50,1);ones(50,1);-0.98*ones(50,1);...
    ones(50,1);0*ones(50,1);ones(50,1);1*ones(50,1);1*ones(50,1);1*ones(50,1);1*ones(50,1);1*ones(50,1);-1*ones(50,1);...danger
   -ones(50,1);-ones(50,1) ;-ones(50,1);-1*ones(50,1);-1*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);ones(50,1);ones(50,1);-1*ones(50,1);-1*ones(50,1);...
   ones(50,1);ones(50,1);ones(50,1);-1*ones(50,1);-1*ones(50,1);-1*ones(50,1);ones(50,1);1*ones(50,1);-0.5*ones(50,1);-0.5*ones(50,1);0*ones(50,1);0.4*ones(50,1);0.8*ones(50,1);...
   ones(50,1);ones(50,1);-ones(50,1);0*ones(50,1);-1*ones(50,1);ones(50,1);ones(50,1);0*ones(50,1);-0.5*ones(50,1);-1*ones(50,1);-1*ones(50,1);0*ones(50,1);ones(50,1);...
   ones(50,1);ones(50,1);0*ones(50,1);-1*ones(50,1);-1*ones(50,1);ones(50,1);ones(50,1);ones(50,1);0*ones(50,1);-1*ones(50,1);-1*ones(50,1);0*ones(50,1);0*ones(50,1);...
   0*ones(50,1);0*ones(50,1);ones(50,1);ones(50,1);0*ones(50,1);-1*ones(50,1);-1*ones(50,1);-1*ones(50,1);-0.5*ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);...
   ones(50,1);ones(50,1);ones(50,1);ones(50,1);-ones(50,1);-ones(50,1);-ones(50,1);-ones(50,1);-ones(50,1);-ones(50,1);ones(50,1);ones(50,1);ones(50,1);-ones(50,1);...
   -ones(50,1);ones(50,1);ones(50,1);ones(50,1);-ones(50,1);-ones(50,1);ones(50,1);ones(50,1);ones(50,1);0*ones(50,1);-ones(50,1);-ones(50,1);0*ones(50,1);ones(50,1);...
   ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(20,1);-ones(30,1);-ones(50,1);-ones(50,1);-ones(50,1);-ones(50,1);-ones(50,1);-ones(50,1);...
   ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(700,1)
