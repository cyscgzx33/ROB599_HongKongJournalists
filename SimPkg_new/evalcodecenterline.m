...
steer_input = 0.5*[-0.05*ones(50,1);-0.03*ones(50,1);-0.02*ones(50,1);-0.01*ones(50,1);-0.02*ones(50,1);-0.005*ones(50,1);0*ones(50,1);0*ones(50,1);0.005*ones(50,1);0.01*ones(50,1);...
    -0.01*ones(50,1);-0.01*ones(50,1);-0*ones(50,1);-0.05*ones(50,1);-0.1*ones(50,1);-0.1*ones(50,1);-0.1*ones(50,1);-0.1*ones(50,1);-0.1*ones(50,1);-0.1*ones(50,1);...
    -0.0*ones(50,1);-0.01*ones(50,1);-0.15*ones(50,1);-0.05*ones(50,1);-0*ones(50,1);-0.05*ones(50,1);-0*ones(50,1);-0.1*ones(50,1);-0.07*ones(50,1);-0.*ones(50,1);...
    -0.*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0.01*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0.05*ones(50,1);0.1*ones(50,1);0.05*ones(50,1);...
    0.05*ones(50,1);0.2*ones(50,1);0.09*ones(50,1);0*ones(50,1);0*ones(50,1);0.01*ones(50,1);0.01*ones(50,1);-0.05*ones(50,1);-0.1*ones(50,1);-0.05*ones(50,1);-0.15*ones(50,1)
   -0.15*ones(50,1);-0.15*ones(50,1);-0.1*ones(50,1);-0.15*ones(50,1);0.05*ones(50,1);0.02*ones(50,1);0.05*ones(50,1);0.08*ones(50,1);0.08*ones(50,1);0.15*ones(50,1);...
   0.2*ones(50,1);0.2*ones(50,1);0.1*ones(50,1);0.07*ones(50,1);0.08*ones(50,1);0.04*ones(50,1);0*ones(20,1);0*ones(30,1);-0.02*ones(50,1);-0.08*ones(50,1);...
   -0.08*ones(50,1);-0.1*ones(50,1);-0.03*ones(50,1);-0.04*ones(50,1);-0.12*ones(50,1);-0.15*ones(50,1);-0.02*ones(50,1);-0.1*ones(50,1);-0.1*ones(50,1);-0*ones(50,1);...
   -0.03*ones(50,1);-0.03*ones(50,1);-0.15*ones(50,1);-0.2*ones(50,1);-0*ones(50,1);-0.15*ones(50,1);-0.25*ones(50,1);-0.24*ones(50,1);-0.04*ones(50,1);-0*ones(50,1);...
   0*ones(50,1);0*ones(50,1);0.01*ones(50,1);0.005*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0.05*ones(50,1);0.2*ones(50,1);0.25*ones(50,1);0.3*ones(50,1);...
   0.3*ones(50,1);0.2*ones(50,1);0*ones(50,1);0.01*ones(50,1);0.03*ones(50,1);0.07*ones(50,1);0.4*ones(50,1);0.3*ones(50,1);0.3*ones(50,1);0.3*ones(50,1);0*ones(50,1);...
   -0.1*ones(50,1);-0.1*ones(50,1);-0.15*ones(50,1);-0.15*ones(50,1);-0.1*ones(50,1);-0.05*ones(50,1);-0.1*ones(50,1);-0.15*ones(50,1);-0.08*ones(50,1);-0.1*ones(50,1);...
   -0.25*ones(50,1);-0.25*ones(50,1);-0.2*ones(50,1);-0.*ones(50,1);-0.2*ones(50,1);-0.35*ones(50,1);-0.4*ones(50,1);-0.4*ones(50,1);-0.2*ones(50,1);0.05*ones(50,1);...
   0.3*ones(50,1);0.5*ones(50,1);0.5*ones(50,1);0.3*ones(50,1);0.5*ones(50,1);0.5*ones(50,1);0.055*ones(50,1);0.00*ones(50,1);0*ones(50,1);-0.01*ones(50,1);-0.01*ones(50,1);...
   -0.0*ones(50,1);0.005*ones(50,1);0.*ones(50,1);0.*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0.05*ones(50,1);0.5*ones(50,1);0.5*ones(50,1);0.5*ones(50,1);...
   0.068*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);-0.005*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0.002*ones(50,1);0*ones(50,1);0*ones(50,1);...
   -0.001*ones(50,1);0*ones(50,1);0.05*ones(50,1);-0.01*ones(50,1);-0.1*ones(30,1);-0.1*ones(20,1);0*ones(60,1)
   ];
% steer_input = [-0.000*ones(300,1);-0.2*ones(300,1);-0.5*ones(150,1)];
force_input = 5000*[0*ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);-2*ones(50,1);-2*ones(50,1);-ones(50,1);...
   
   0*ones(50,1);0*ones(50,1);0*ones(50,1);ones(50,1);0*ones(50,1);-ones(50,1);-ones(50,1);0.5*ones(50,1);0.5*ones(50,1);ones(50,1);-ones(50,1);0*ones(50,1);0*ones(50,1);...
   0*ones(50,1);0*ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);-2*ones(50,1);-2*ones(50,1);-2*ones(50,1);-ones(50,1);...
   -ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);ones(50,1);ones(50,1);ones(50,1);-2*ones(50,1);-ones(50,1);0*ones(50,1);0*ones(50,1);...
   ones(50,1);-ones(50,1);ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);-ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);...
   ones(50,1);ones(50,1);ones(50,1);ones(50,1);-2*ones(50,1);-2*ones(25,1);0*ones(25,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);ones(50,1);...
   ones(50,1);ones(50,1);ones(50,1);-2*ones(50,1);-2*ones(30,1);0*ones(20,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);...
   0*ones(50,1);0*ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);-2*ones(50,1);-2*ones(50,1);-2*ones(50,1);-2*ones(15,1);0*ones(35,1);0*ones(50,1);...
   0*ones(50,1);0*ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);-2*ones(50,1);-2*ones(50,1);-2*ones(50,1);0*ones(50,1);...
   0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);ones(50,1);ones(50,1);-2*ones(50,1);ones(50,1);ones(50,1);ones(25,1);-2*ones(25,1);0*ones(50,1);...
   0*ones(50,1);ones(50,1);0*ones(50,1);0*ones(50,1);-1.2*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);0*ones(50,1);-ones(50,1);ones(50,1);-ones(25,1);ones(75,1);...
   ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(30,1);-2*ones(70,1);-2*ones(50,1);-2*ones(50,1);-2*ones(40,1);0*ones(10,1);...
   0*ones(50,1);0*ones(50,1);0*ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);...
   ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(50,1);ones(60,1)
   ]; 
%U = [steer_input, force_input];
ii=1;
for jj=[50 0]

U = [steer_input(1:end-jj), force_input(1:end-jj)];
...
xx=traj.x;
yy=traj.y;
disx(:,ii)=xx(end-99+jj:end-50+jj);
disy(:,ii)=yy(end-99+jj:end-50+jj);
ii=ii+1;
%%
...
ss=( disx(:,1)-disx(:,2) ).^2+( disy(:,1)-disy(:,2) ).^2;
ss=sqrt(ss);
max(ss)
traj_ctl = [xx,yy];
U=U(1:8690,:);
traj_ctl=traj_ctl(1:8690,:);
 checkTrajectory(traj_ctl,U,[])