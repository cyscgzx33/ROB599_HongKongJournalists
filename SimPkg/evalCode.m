...
plot(TestTrack.bl(1,:),TestTrack.bl(2,:),'k','Markersize',5);
plot(TestTrack.br(1,:),TestTrack.br(2,:),'k','Markersize',5);
plot(TestTrack.cline(1,:),TestTrack.cline(2,:),'k--','Markersize',5);
